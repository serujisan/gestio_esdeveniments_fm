...
class GE_Admin_Categories {
    ...
    public function add_category_fields($taxonomy) {
        ...
        <div class="form-field">
            ...
            <p>
                <label>
                    <input type="checkbox" name="nom_artista" value="1">
                    Nom Artista
                </label>
            </p>
            <p>
                <label>
                    <input type="checkbox" name="municipio" value="1">
                    Municipi
                </label>
            </p>
            <p>
            ...
            <p>
                <label>
                    <input type="checkbox" name="que_hacer" value="1">
                    Què Fer
                </label>
            </p>
            <p>
                <label>
                    <input type="checkbox" name="concierto" value="1">
                    Concert
                </label>
            </p>
            <p>
                <label>
                    <input type="checkbox" name="notas" value="1">
                    Notes
                </label>
            </p>
    ...
    public function edit_category_fields($term) {
        ...
        $nom_artista = get_term_meta($term_id, 'nom_artista', true);
        $municipio = get_term_meta($term_id, 'municipio', true);
        $any = get_term_meta($term_id, 'any', true);
        $que_hacer = get_term_meta($term_id, 'que_hacer', true);
        $concierto = get_term_meta($term_id, 'concierto', true);
        $notas = get_term_meta($term_id, 'notas', true);
        ?>
        <tr class="form-field">
            <th scope="row">
                <label>Camps per Generar Text</label>
            ...
            <td>
                <fieldset>
                    <p>
                        <label>
                            <input type="checkbox" name="nom_artista" value="1" <?php checked($nom_artista, '1'); ?>>
                            Nom Artista
                        </label>
                    </p>
                    <p>
                        <label>
                            <input type="checkbox" name="municipio" value="1" <?php checked($municipio, '1'); ?>>
                            Municipi
                        </label>
                    </p>
                    <p>
                        <label>
                            <input type="checkbox" name="any" value="1" <?php checked($any, '1'); ?>>
                            Any
                        </label>
                    </p>
                    <p>
                        <label>
                            <input type="checkbox" name="que_hacer" value="1" <?php checked($que_hacer, '1'); ?>>
                            Què Fer
                        </label>
                    </p>
                    <p>
                        <label>
                            <input type="checkbox" name="concierto" value="1" <?php checked($concierto, '1'); ?>>
                            Concert
                        </label>
                    </p>
                    <p>
                        <label>
                            <input type="checkbox" name="notas" value="1" <?php checked($notas, '1'); ?>>
                            Notes
                        </label>
                    </p>
                    <p class="description">Selecciona els camps que s'utilitzaran per generar el text de la categoria.</p>
    ...
    public static function generate_category_text($term_id, $event_data) {
        $fields = array(
            'nom_artista' => isset($event_data['artista']) ? $event_data['artista'] : '',
            'municipio' => isset($event_data['poblacio']) ? $event_data['poblacio'] : '',
            'any' => date('Y'),
            'que_hacer' => isset($event_data['que_hacer']) ? $event_data['que_hacer'] : '',
            'concierto' => isset($event_data['concierto']) ? $event_data['concierto'] : '',
            'notas' => isset($event_data['notas']) ? $event_data['notas'] : ''
        );
